            ...
            if ($_POST["submit"]) {
                ...
                if (mysqli_query($link, $insert_query)) {
                    ...
                    if ($percent >= 90 && $percent <= 100) {
                        ?>
                            <!-- <h1 style="color: green; font-weight: bold">High Score</h1> -->
                            <h4>Congratulations!</h4>
                            <p>You scored  <?php echo $score?> out of <?php echo $item?> </p>
                            <p>You're a quiz superstar.</p>
                    <?php } else if ($percent >= 75 && $percent < 90) {
                        ?>

                            <!-- <h1 style="color: green; font-weight: bold">Average Score</h1> -->
                            <h4>Well done!</h4>
                            <p>You scored <?php echo $score?> out of <?php echo $item?> </p>
                        ...
                        ?>
                        <!-- <h1 style="color: red; font-weight: bold">Low score</h1> -->
